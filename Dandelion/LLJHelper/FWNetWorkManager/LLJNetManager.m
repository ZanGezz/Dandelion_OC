...
- (void)startWithMethod:(NSString *)method
    ...
    [urlRequest setValue:[FWLangageHelper getParamLangage] forHTTPHeaderField:@"Accept-Language"];
...
- (void)postAFNWRequest:(FWBaseReq*)request
    ...
    [manager.requestSerializer setValue:[FWLangageHelper getParamLangage] forHTTPHeaderField:@"Accept-Language"];
