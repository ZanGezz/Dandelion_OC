...
- (instancetype)initWithDeviceType:(SRDeviceType)type{
    ...
    }else if (type == SRDeviceTypeAudio){
        
        BPAudioRecorderViewController *vc = [[BPAudioRecorderViewController alloc] initWithNibName:@"BPAudioRecorderViewController" bundle:nil];
        self = [super initWithRootViewController:vc];
    }else{//相机
