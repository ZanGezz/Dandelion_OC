...
@property(nonatomic, assign) BOOL isSelectGender;     //是否选择性别
...
@property (nonatomic, strong) NSDate *assignDate;  // 指定天
...
- (void)datePicker:(PGDatePicker *)datePicker didSelectDate:(NSDateComponents *)dateComponents gender:(NSString *)gender;
@end
