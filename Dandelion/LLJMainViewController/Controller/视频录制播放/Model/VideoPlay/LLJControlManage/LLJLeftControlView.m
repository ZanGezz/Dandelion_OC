...
@implementation LLJLeftControlView

- (instancetype)initWithPlayerModel:(LLJVideoPlayModel *)model {
    self = [super initWithPlayerModel:model type:LLJControlViewTypeLeft];
    if (self) {
        ...
        case LLJAddsubViewTypeLeftOrTop:
        {
            ...
            for (int i = 0; i < self.leftOrTopSubViewArray.count; i ++) {
                ...
                if (model.subView) {
                    ...
                    [self setUpanimateHiddenSmallScreenFrame:model type:LLJControlViewTypeLeft];
                }
            }
        }
            break;
