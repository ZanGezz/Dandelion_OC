...
//        [self.button addTarget:self action:@selector(buttonC) forControlEvents:UIControlEventTouchUpInside];
...
//- (void)buttonC {
//    [MBProgressHUD showMessag:@"dian ji" toView:kRootView hudModel:MBProgressHUDModeText hide:YES];
//    NSLog(@"buttonC");
//}
#pragma mark - 布局 -
- (void)layoutSubview{
